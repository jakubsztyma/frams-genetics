...
// Modifier mode
			...
			{"S:EE{ry=90.0;z=2.0}",                               "p:sh=1\n"
																  ...
																  "j:0, 1, sh=1\n"},
			{"S:E{ry=90.0;z=2.0}E{ry=90.0;z=2.0}",                "p:sh=1, sz=2.0, ry=1.5707963267948966\n"
			...
			{"S:E[Sin_2;T_0;T_0_1]",                                "p:sh=1\n"
																  ...
																  "c:2, 0\n"
																  "c:2, 1\n"},
			{"S:E[Sin_2;T_0;T_0_1]{ry=90.0;z=2.0}E{ry=90.0;z=2.0}", "p:sh=1, sz=2.0, ry=1.5707963267948966\n"
																  "p:4.0, sh=1, sz=2.0, ry=1.5707963267948966\n"
																  "j:0, 1, sh=1\n"
																  "n:p=0, d=Sin\n"
																  "n:p=0, d=T\n"
