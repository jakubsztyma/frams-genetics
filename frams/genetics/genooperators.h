...
public:
	Param par;
	SString supported_format; ///<genotype format which is supported by this class ("6" for GenoOper_f6, "Latent" for GenoOper_fLatent, etc.). Must be initialized in constructor.
	string name; ///<short human-friendly name of this genetic representation/set of genetic operators
